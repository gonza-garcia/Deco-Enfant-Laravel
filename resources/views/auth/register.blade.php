...
@section('custom_scripts')
    <script src="{{asset('js/fill_countries_and_provinces.js')}}"></script>
@endsection
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id='register' method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                          <label for="sex_id" class="col-md-4 col-form-label text-md-right">{{ __('Seleccione su sexo') }}</label>

                          <div class="col-md-6">
                              <select class="form-control @error('sex_id') is-invalid @enderror" id='sex_id' name='sex_id' value="{{ old('sex_id') }}">
                        ...
                        <div class="form-group row">
                            <label for='country_id' class="col-md-4 col-form-label text-md-right">{{ __('Seleccione su país') }}</label>

                            <div class="col-md-6">
                                <input type='hidden' id='old_country_id' value="{{ old('country_id') }}">
                        ...
                        <div class="form-group row">
                            <label for='province_id' class="col-md-4 col-form-label text-md-right">{{ __('Seleccione su provincia') }}</label>

                            <div class="col-md-6">
                                <input type='hidden' id='old_province_id' value="{{ old('province_id') }}">
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label text-md-right">{{ __('Elija su contraseña') }}</label>
