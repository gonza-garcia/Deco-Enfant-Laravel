            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="date_of_birth" class="col-md-4 col-form-label text-md-right">{{ __('Fecha de nacimiento') }}</label>
                        ...
                        <div class="form-group row">
                          <label for="sex_id" class="col-md-4 col-form-label text-md-right">{{ __('Seleccione el sexo') }}</label>
                        ...
                        <div class="form-group row">
                          <label for="user_status_id" class="col-md-4 col-form-label text-md-right">{{ __('Seleccione el estado') }}</label>
                        ...
                        <div class="form-group row">
                          <label for="role_id" class="col-md-4 col-form-label text-md-right">{{ __('Seleccione el rol') }}</label>
